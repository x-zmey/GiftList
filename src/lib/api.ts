...
const SEED_PRODUCTS: Product[] = [
  ...
  { id: 'p6', registryId: 'r1', title: 'Waterford Crystal Wine Glasses Set of 6', price: 295.00, image: 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=400&h=400&fit=crop&q=80', store: 'Amazon', storeUrl: 'https://amazon.com/waterford-glasses', affiliateUrl: 'https://amazon.com/waterford-glasses?tag=giftlist-20', category: 'Dining', priority: 'dream', purchaseStatus: 'available', addedVia: 'catalog', inStock: true, lastPriceCheck: '2026-07-27T06:00:00Z', priceHistory: makePriceHistory(295.00), quantity: 1, createdAt: '2026-05-16T10:00:00Z' },
  { id: 'p7', registryId: 'r1', title: 'All-Clad D5 Stainless 10-Piece Cookware Set', price: 899.99, image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=400&h=400&fit=crop&q=80', store: 'Williams Sonoma', storeUrl: 'https://williams-sonoma.com/all-clad', affiliateUrl: 'https://williams-sonoma.com/all-clad?ref=giftlist', category: 'Kitchen', priority: 'dream', purchaseStatus: 'available', addedVia: 'manual', inStock: true, lastPriceCheck: '2026-07-27T06:00:00Z', priceHistory: makePriceHistory(899.99), quantity: 1, createdAt: '2026-05-17T10:00:00Z' },
  ...
  // Housewarming (r4)
  { id: 'p18', registryId: 'r4', title: 'Philips Hue Starter Kit - White & Color', price: 199.99, image: 'https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?w=400&h=400&fit=crop&q=80', store: 'Amazon', storeUrl: 'https://amazon.com/philips-hue', affiliateUrl: 'https://amazon.com/philips-hue?tag=giftlist-20', category: 'Smart Home', priority: 'must-have', purchaseStatus: 'available', addedVia: 'catalog', inStock: true, lastPriceCheck: '2026-07-27T06:00:00Z', priceHistory: makePriceHistory(199.99), quantity: 1, createdAt: '2026-07-21T10:00:00Z' },
...
const SEED_CATALOG: CatalogProduct[] = [
  ...
  { id: 'c3', title: 'Dyson V15 Detect Cordless Vacuum', price: 749.99, image: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=400&h=400&fit=crop&q=80', store: 'Amazon', storeUrl: 'https://amazon.com/dyson-v15', category: 'Home', rating: 4.6, reviewCount: 5670 },
  ...
  { id: 'c7', title: 'UPPAbaby Vista V3 Stroller', price: 1099.99, image: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=400&h=400&fit=crop&q=80', store: 'Amazon', storeUrl: 'https://amazon.com/uppababy-vista', category: 'Baby Gear', rating: 4.8, reviewCount: 2340 },
  ...
  { id: 'c11', title: 'Philips Hue Starter Kit', price: 199.99, image: 'https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?w=400&h=400&fit=crop&q=80', store: 'Amazon', storeUrl: 'https://amazon.com/philips-hue', category: 'Smart Home', rating: 4.5, reviewCount: 12300 },
  { id: 'c12', title: 'iRobot Roomba j7+ Robot Vacuum', price: 599.00, image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400&h=400&fit=crop', store: 'Amazon', storeUrl: 'https://amazon.com/roomba-j7', category: 'Home', rating: 4.4, reviewCount: 7800 },
];
...
const SIMULATED_PRODUCTS: Record<string, { title: string; price: number; image: string; category: string }> = {
  'amazon': { title: 'Echo Dot (5th Gen) Smart Speaker with Alexa', price: 49.99, image: 'https://images.unsplash.com/photo-1583394838336-acd977736f90?w=400&h=400&fit=crop&q=80', category: 'Smart Home' },
  'target': { title: 'Threshold Ceramic Table Lamp - White', price: 34.99, image: 'https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?w=400&h=400&fit=crop&q=80', category: 'Home Decor' },
  'walmart': { title: 'Beautiful 12-Piece Cookware Set by Drew Barrymore', price: 119.00, image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=400&h=400&fit=crop&q=80', category: 'Kitchen' },
